...
c       19 APR 2024 - corrected an error in subroutine output
c                     where gpoly was invoked with solsiz undefined
c                     replaced with 0.03
c       17 APR 2025 - corrected login error in the specification of 
c                     different colors for modes. The problem was too many
c                     calls to change the color. This is in subroutine outplt
c----------------------------------------------------------------------c
        integer LIN, LER, LOT
...
c-----
  ...
  500   continue
            ...
            do 300 i=1,kmode
c----
c   these two lines moved above 2026/04.17
c       call mapkolor(kkolor,i-1, modmax,kolor)
c       call newpen(kolor)
c-----
...
c-----
     ...
     1                  y0,ylen,yy,yyp,yym)
                    ...
                    if(doblack)then
                    call newpen(1)
                    call gpoly(xx,yy,0.03,jmode(i)+1)
