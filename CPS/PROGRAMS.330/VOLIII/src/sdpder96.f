...
c       30 JUL 2024 - corrected online help
c----------------------------------------------------------------------c
...
c-----
 ...
 2000   continue
     ...
     1  '-AG      (default false) for use with acoustic gravity code'
        write(LER,*)
     1  '-V         (default false) output depth values in S?EGN.VER'
        write(LER,*)
     1  '  Mode Layer Ztop Uphi Tphi dcdh dcdb dcdr for Love:'
        write(LER,*)
     1  '  Mode Layer Ztop Ur Tr Uz Tz dcdh dcda dcdb dcdr for Rayleigh'
        write(LER,*)
