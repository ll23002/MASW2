...
c-----
                ...
                call wint(sumd,gg1,h0,h1z,t01,0,dkk,r,wvn)
...
c-----
                ...
                call wint(sumd,gg1,h0,h1z,t01,1,dkk,r,wvn)
...
c-----
            if(jsrc(4).eq.1.and.jsrc(13).eq.1)then
                ...
                call wint(sumc,gg1,h0,h1z,t01,10,dkk,r,wvn)
            endif
            if(jsrc(4).eq.1)then
c-----
c       RDS
...
c-----
                ...
                call wint(sumd,gg1,h0,h1z,t01,2,dkk,r,wvn)
...
c-----
            if(jsrc(6).eq.1.and.jsrc(14).eq.1)then
                ...
                call wint(sumc,gg1,h0,h1z,t01,20,dkk,r,wvn)
            endif
            if(jsrc(6).eq.1)then
c-----
c       RSS
...
c-----
        ...
        subroutine wint(smm,g1,h0,h1z,t01,n,dkk,r,wvn)
c-----
...
c-----
        ...
        do 1010 jr=1,mdpthr
            k = k + 1
            call wwint(smm(k),g1(k),h0,h1z,t01,n,dkk,r,wvn)
 1010   continue
 1000   continue
        return
        end

        subroutine wwint(smm,g1,h0,h1z,t01,n,dkk,r,wvn)
        complex smm,g1
        complex h0, h1z
        complex h2
        complex h1
...
c-----
            elseif(n.eq.20)then
                if(t01.eq.0.0)then
                    ...
                    j21 = 2.*real(h1z)*wvn/t01 - real(h0)
                endif
                if(r.le.rlim)then
                    smm = (0.0,0.0)
                else
